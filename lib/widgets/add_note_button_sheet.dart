...
class add_note_button_sheet extends StatefulWidget {
  const add_note_button_sheet({super.key});

  @override
  State<add_note_button_sheet> createState() => _add_note_button_sheetState();
}

class _add_note_button_sheetState extends State<add_note_button_sheet> {
  @override
